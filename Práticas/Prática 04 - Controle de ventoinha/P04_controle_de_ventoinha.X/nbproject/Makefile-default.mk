...
FINAL_IMAGE=${DISTDIR}/P04_controle_de_ventoinha.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/P04_controle_de_ventoinha.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F4520
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/P04_controle_de_ventoinha.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/P04_controle_de_ventoinha.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F4520 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/P04_controle_de_ventoinha.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
